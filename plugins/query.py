...
async def Cb_Handle(bot: Client, query: CallbackQuery):
    ...
    if data.startswith('stats'):
        ...
        try:
            ...
            ffmpeg = "-preset fast -c:v libsvtav1 -s 1280x720 -svtav1-params 'bframes=8:psy-rd=1:ref=3:aq-mode=3:aq-strength=0.8:deblock=1,1' -pix_fmt yuv420p -crf 52 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -ab 32k -vbr 2 -level 3.1 -threads 5"
